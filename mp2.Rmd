...
After correctly labeling the different transaction types as true (supported candidate) or false (opposed candidate), we then needed the total amounts for transaction types that spent money opposing candidates and a total amount for transaction types that spent money supporting candidates. Since we had previously created a coloumn specifying the objectives of each transaction type, it made it easy to group them together and find the totals for each.
...
>>>>>>> 78d128fbff0c5ccc1480cf1910b0fb8491913647
